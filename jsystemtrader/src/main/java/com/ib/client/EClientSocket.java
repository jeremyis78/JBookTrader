...
public class EClientSocket {
    ...
    private static final int CLIENT_VERSION = 30;
    ...
    public synchronized void reqHistoricalData(int tickerId, Contract contract, String endDateTime, String durationStr,
    ...
    public synchronized void exerciseOptions(int tickerId, Contract contract, int exerciseAction, int exerciseQuantity,
    ...
    public synchronized void placeOrder(int id, Contract contract, Order order) {
        ...
        try {
            ...
            if (m_serverVersion >= 19) {
                ...
                double lower = (m_serverVersion == 26 && order.m_orderType.equals("VOL")) ? Double.MAX_VALUE :
                               order.m_stockRangeLower;
                double upper = (m_serverVersion == 26 && order.m_orderType.equals("VOL")) ? Double.MAX_VALUE :
