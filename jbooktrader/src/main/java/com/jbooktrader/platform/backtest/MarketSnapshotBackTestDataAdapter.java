 ...
 */
public class MarketSnapshotBackTestDataAdapter implements BackTestData<MarketSnapshot> {
    ...
    @Override
    public String toDataRow(MarketSnapshot snapshot, DateTimeFormatter dateFormat, DecimalFormat decimalFormat) {
